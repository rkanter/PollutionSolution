...
namespace PollutionSolution
{
    ...
    // TODO: ansel testing
    // TODO: license
    public class PollutionSolution : ThreadingExtensionBase, IUserMod
    {
        ...
        // TODO: make this less ugly (i.e. set a better way instead of public static)
        private bool removeNoisePollution = true;
        private bool removeGroundPollution = true;
        private bool removeWaterPollution = true;
